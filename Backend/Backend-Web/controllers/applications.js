...
// All application-related functions for stall applications
...
export const applicationController = {
  ...
  // Get all applicants (from landing page controller)
  ...
  // Get applicant by ID (from landing page controller)
...
// Export individual functions for better modularity
export const {
  createApplication,
  getAllApplications,
  getApplicationById,
